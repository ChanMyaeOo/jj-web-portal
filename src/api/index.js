...
export const getNoticeTotal = () => API.get('/posts/ntotal')
export const getLivTotal = () => API.get('/posts/livtotal')
export const getBuySellTotal = () => API.get('/posts/btotal')
export const getJobSearchTotal = () => API.get('/posts/jtotal')